...
function App() {
  return (
    ...
    <div className="App">
    <Header/>
    <div id='app__content' className=' md:!pt-24 lg:!pb-[400px]'>
    <div className="whatsapp-sticker lg:right-8">
            <a href="https://wa.me/918791453391" target='blank' className="sticky" data-tooltip-id="my-tooltip" data-tooltip-content="Whatsapp Us">
