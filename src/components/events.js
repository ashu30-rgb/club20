...
import btb from "../assets/events/BREAK THE BARRIERS.jpg";
import nirv_2 from "../assets/events/NIRVANA 2.0.jpg";
import guiness from "../assets/events/GUINNESS BOOK WORLD RECORD FOR DRUG AWARNES.jpg";
import SWACHHTHON from "../assets/events/SWACHHTHON.jpg";
import MoHUA from "../assets/events/SWACHHATA MoHUA APP INTERNSHIP.jpg";
import acl from "../assets/events/AFRICA CHAMPIONS LEAGUE.jpg";
import ysf from "../assets/events/YOUTH SPEAK FORUM.jpg";
import bhangra from "../assets/events/GUINNESS BOOK WORLD RECORD FOR BHANGRA.jpg";
import isc from "../assets/events/INDIAN SCIENCE CONGRESS (ICS).jpg";
import Shaurya from "../assets/events/SHAURYA.jpg";
import rfg from "../assets/events/RACE FOR GRACE.jpg";
import IECON from "../assets/events/IECON.jpg";
import fitness_talk from "../assets/events/FITNESS TALK.jpg";
import jang_e_azadi from "../assets/events/JANG-E-AZADI VISIT.jpg";
import dwm from "../assets/events/DAILY WORLD MARATHON.jpg";
import final_yr_pht from "../assets/events/FINAL YEAR PHOTOGRAPHY.jpg";
import kalank from "../assets/events/PRESS CONFRENCE WITH KALANK STAR CAST.jpg";
import JALIYANWALA from "../assets/events/CENTURY OF JALIYANWALA BAGH.jpg";
import SADHBHAVANA from "../assets/events/SADHBHAVANA.jpg";
import KTM from "../assets/events/KTM STUNT SHOW.jpg";
import AIRBEAT from "../assets/events/AIRBEAT FIESTA.jpg";
import three_bl from "../assets/events/3BL.jpg";
import VANDE from "../assets/events/VANDE MATARAM.jpg";
import sports_utsav from "../assets/events/SPORTS UTSAV.jpg";
import GLOWRUN from "../assets/events/GLOWRUN ELECTRICA.jpg";
import SUNBURN from "../assets/events/SUNBURN.jpg";
import NESOJ from "../assets/events/NESOJ.jpg";
import IIC from "../assets/events/IIC TRAINING.jpg";
import SHAURYA_2 from "../assets/events/SHAURYA_2.jpg";
import rfg_2 from "../assets/events/RACE FOR GRACE 2.O.jpg";
import campus_princess from "../assets/events/CAMPUS PRINCESS.jpg";
import KHEL_E_TALASH from "../assets/events/KHEL-E-TALASH.jpg";
import aos from 'aos';
        ...
        <div className="container md:!px-5 px-0 py-24 mx-auto">
          <div className="flex flex-wrap w-full">
            <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
              ...
              <img loading=" lazy" data-aos="fade-up" src={events} alt="events"></img>
            </div>
