...
{/* Gallery Collage */}
      <Carousel autoPlay="true" infiniteLoop="true" showThumbs={false} dynamicHeight={false} showStatus={false} showIndicators={false}>
        <div className="container mx-auto  px-0 md:px-16 py-2 lg:px-32 lg:pt-24 mb-4 md:mb-10" data-aos="fade-up">
...
<div className="w-screen flex items-center justify-center px-10 p-2">
  <img width="400" height="200"  src="https://res.cloudinary.com/dt5k5t2kd/image/upload/v1705847172/Club%20twenty%20Website/WEBSITE%20IMAGES/FAQ_g423dk.webp" alt="FAQS" data-aos="fade-up" className="max-w-lg mx-auto"></img>
</div>
